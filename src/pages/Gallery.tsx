  ...
  return (
    <div className="bg-[#F7F6F2] min-h-screen">
      ...
      >
        ...
        >
          <p className="text-[10px] font-black uppercase tracking-[0.26em] text-[#D4A800] mb-4">
            Tirupathi Balaji Herbal Store
          </p>
          <h1 className="text-[2.8rem] sm:text-[3.6rem] font-black text-[#1A1A1A] tracking-tight leading-[1.02] mb-4">
            Inside Our Store
          </h1>
          <p className="text-[16px] sm:text-[18px] font-black text-[#D4A800] mb-4">
        ...
        <div className="flex flex-wrap justify-center gap-8 sm:gap-14 mb-12 sm:mb-16">
          {[
            ...
            <div key={stat.label} className="text-center">
              <p className="text-[2rem] sm:text-[2.5rem] font-black text-[#1A1A1A] leading-none">{stat.value}</p>
              <p className="text-[11px] font-bold text-[#6B7280] mt-1 uppercase tracking-[0.15em]">{stat.label}</p>
            </div>
          ))}
        </div>
          ...
          {galleryImages.map((img, idx) => (
            ...
            >
              <div className="relative overflow-hidden rounded-[20px] sm:rounded-[24px]
                ...
                transition-shadow duration-300 bg-[#F0E6C8]/20">
                <img
                  src={img.image}
                  alt={img.title}
                  loading="lazy"
                ...
                {idx === 0 && (
                  <div className="absolute top-3 left-3 bg-[#1A1A1A] text-white
