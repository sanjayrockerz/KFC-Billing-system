...
export default function AdminLogin() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#f7f6f2] px-4 py-8 font-sans text-[#2C392A] sm:px-6 lg:flex lg:items-center lg:justify-center">
      <div className="pointer-events-none absolute -left-32 -top-32 h-80 w-80 rounded-full bg-[#D4A800]/10 blur-3xl" />
      ...
      <div className="relative grid w-full max-w-5xl overflow-hidden rounded-[32px] border border-[#E7D9BF] bg-white shadow-[0_24px_80px_rgba(44,57,42,0.14)] lg:grid-cols-[0.9fr_1.1fr]">
        <div className="hidden flex-col justify-between bg-[#2C392A] p-10 text-white lg:flex">
          <div>
            <div className="mb-8 flex h-14 w-14 items-center justify-center rounded-xl bg-white shadow-[0_4px_12px_rgba(17,24,39,0.10)] overflow-hidden"><img src="/logo.png" alt={`${BRAND_EN} logo`} className="w-full h-full object-cover scale-[1.8]" /></div>
        ...
        <div className="mb-8 flex flex-col items-center text-center lg:items-start lg:text-left">
          <div className="mb-5 flex h-16 w-16 items-center justify-center rounded-xl bg-white shadow-[0_4px_12px_rgba(17,24,39,0.10)] overflow-hidden lg:hidden"><img src="/logo.png" alt={`${BRAND_EN} logo`} className="w-full h-full object-cover scale-[1.8]" /></div>
          <p className="text-[11px] font-black uppercase tracking-[0.24em] text-[#D4A800]">{BRAND_SUBTITLE}</p>
          ...
          <p className="mt-4 inline-flex items-center gap-2 rounded-full border border-[#E7D9BF] bg-[#FBFAF6] px-3 py-1.5 text-[11px] font-black uppercase tracking-wider text-[#D4A800]">
            <ShieldCheck size={13} />
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-2xl border-2 border-[#E7D9BF] bg-[#FBFAF6] px-4 py-3.5 pr-12 text-sm font-semibold outline-none transition-colors placeholder:text-[#AAA69C] focus:border-[#D4A800] focus:bg-white"
                value={password}
          ...
          <button
            type="submit"
            disabled={loading}
            className="group flex w-full items-center justify-center gap-2 rounded-2xl bg-[#D4A800] py-3.5 font-black text-white shadow-lg shadow-[#D4A800]/20 transition-colors hover:bg-[#1A1A1A] disabled:opacity-60"
          >
            {loading ? (
              <>
