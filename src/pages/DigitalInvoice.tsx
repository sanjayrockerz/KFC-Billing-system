  ...
  if (error || !invoice) {
    return (
      <div className="min-h-screen bg-[#f9faf6] flex flex-col items-center justify-center text-center p-6">
        <h1 className="text-2xl font-bold text-yellow-dark mb-2">Invoice Not Found</h1>
        <p className="text-gray-500 mb-6">{error}</p>
        <Link to="/" className="px-6 py-2 bg-yellow text-white rounded-full font-bold hover:bg-yellow-dark transition">
          Return Home
        </Link>
      </div>
    )
  ...
  return (
    <div className="min-h-screen bg-[#f9faf6] font-sans pb-12 print:bg-white print:pb-0">
      ...
      <div className="bg-[#f9faf6] p-4 sticky top-0 z-50 print:hidden flex items-center justify-between max-w-4xl mx-auto">
        <Link to="/" className="flex items-center gap-2 text-yellow-dark hover:text-[#2d5a27] font-semibold text-sm transition-colors bg-white border border-[#F0E6C8]/40 px-4 py-2 rounded-full shadow-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-yellow-dark text-white px-5 py-2 rounded-full font-bold text-sm shadow-md hover:bg-yellow-dark transition-colors"
          >
      ...
      <div className="max-w-3xl mx-auto mt-4 print:mt-0 px-2 sm:px-0">
        <div className="bg-white shadow-xl rounded-2xl overflow-hidden print:shadow-none print:rounded-none border border-[#F0E6C8]/20 print:border-none">
          <Invoice
            invoiceNo={invoice.invoice_no}
            date={invoice.created_at}
            customerName={invoice.customer_name}
