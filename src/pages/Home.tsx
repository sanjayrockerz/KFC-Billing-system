...
export default function Home() {
  ...
  return (
    <div className="bg-[#F7F6F2] text-[#1A1A1A]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full mb-6
              bg-[#D4A800]/10 border border-[#D4A800]/20">
            ...
            <h1 className={`font-black mb-5 break-words ${
              ...
              <span className="block text-[#1A1A1A]">{t('hero.title1')}</span>
              <span className="block text-[#D4A800]">{t('hero.title2')}</span>
            </h1>

            {/* Subtitle */}
            <p className={`text-[15px] sm:text-[16px] text-[#6B7280] leading-[1.7] font-medium mb-2.5 ${
            ...
            <p className="text-[13px] sm:text-[14px] font-semibold text-[#D4A800]/75
            ...
            <div className="flex flex-wrap gap-3 items-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5
                  bg-white text-[#1A1A1A] font-semibold rounded-full
                  border border-[#1A1A1A]/10
                  text-[13px] sm:text-[14px]
                  shadow-sm
                  hover:bg-[#F7F6F2] hover:border-[#1A1A1A]/20
                  transition-all duration-200"
              >
                <Leaf size={13} className="text-[#D4A800]" />
                {t('remedy.title')}
              </a>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <div className="bg-white rounded-2xl px-4 py-3.5
                ...
                border border-[#F0E6C8]/50
                flex items-center gap-3">
                <div className="w-8 h-8 rounded-xl bg-[#D4A800] flex items-center justify-center shrink-0">
                  <Leaf size={14} className="text-white" />
                </div>
                <div>
                  <p className="text-[12px] font-black text-[#1A1A1A] leading-tight">100% Natural</p>
                  <p className="text-[10px] text-[#6B7280] font-medium mt-0.5">Siddha Certified</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white rounded-2xl px-4 py-3.5
                ...
                <p className="text-[13px] font-black text-[#1A1A1A] leading-tight">4.9 / 5.0</p>
                <p className="text-[10px] text-[#6B7280] font-medium mt-0.5">Happy Customers</p>
              </div>
            </motion.div>
          ...
          {[
            ...
            <div key={idx}
              className="flex items-center gap-3.5 p-4 sm:p-5
                ...
                border border-[#F0E6C8]/35
                shadow-sm
                hover:-translate-y-0.5 transition-transform duration-200"
            >
              <div className="w-9 h-9 rounded-xl bg-[#D4A800]/12 flex items-center justify-center shrink-0 text-[#D4A800]">
                {item.icon}
              </div>
              <div className="min-w-0">
                <h4 className="font-bold text-[12px] sm:text-[13px] text-[#1A1A1A] leading-normal ta-text">{item.title}</h4>
                <p className="text-[10px] text-[#6B7280] font-medium mt-0.5 leading-normal ta-text">{item.sub}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <div className="flex justify-between items-end mb-10">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#D4A800] mb-2">Browse Collection</p>
            <h2 className={`font-black text-[#1A1A1A] break-words ${lang === 'ta' ? 'text-2xl sm:text-[30px] leading-[1.4] tracking-[0] ta-text' : 'text-3xl sm:text-[38px] tracking-tight'}`}>{t('cat.title')}</h2>
          </div>
          <Link to="/products"
            className="text-[13px] font-bold text-[#D4A800] flex items-center gap-1 group hover:text-[#5e8c72] transition-colors">
            {t('cat.view_all')}
        ...
        ">
            ...
            >
              <Link to={`/products?cat=${encodeURIComponent(c.name)}`} className="flex flex-col items-center group">
                ...
                <div className="w-full aspect-square rounded-2xl overflow-hidden relative
                  border border-[#F0E6C8]/30 shadow-sm
                  ...
                  <div className="absolute inset-0 flex items-center justify-center
                    bg-[#1A1A1A]/0 group-hover:bg-[#1A1A1A]/30 transition-colors duration-300">
                    <span className="opacity-0 group-hover:opacity-100 transition-opacity duration-300
                      bg-white/95 text-[#1A1A1A] text-[11px] font-black px-3 py-1.5 rounded-full
                      shadow-[0_2px_12px_rgba(44,57,42,0.18)]">
                      {c.count} items
                    </span>
                  </div>
                </div>
                <span className="text-[10px] sm:text-[11px] font-bold text-[#1A1A1A] text-center leading-tight
                  group-hover:text-[#D4A800] transition-colors duration-200">
                  {c.name}
                </span>
              </Link>
            </motion.div>
          ...
          >
            <Link to="/products" className="flex flex-col items-center group">
              <div className="w-full aspect-square rounded-2xl bg-[#1A1A1A] flex items-center justify-center
      ...
      {/* ═══ HEALTH CONCERNS ═══ */}
      <section id="concerns" className="bg-white py-16 sm:py-24 border-y border-[#F0E6C8]/30 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <div className="mb-12">
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#D4A800]">{t('remedy.badge')}</p>
            <h2 className={`font-black mt-3 mb-3 text-[#1A1A1A] break-words ${lang === 'ta' ? 'text-2xl sm:text-[30px] leading-[1.4] tracking-[0] ta-text' : 'text-3xl sm:text-[38px] tracking-tight'}`}>{t('remedy.title')}</h2>
            <p className={`text-[15px] text-[#6B7280] mx-auto font-medium leading-relaxed ${lang === 'ta' ? 'max-w-full ta-text' : 'max-w-xl'}`}>{t('remedy.sub')}</p>
          </div>
          <div className="flex flex-wrap justify-center gap-3">
            {derivedRemedies.map((r, idx) => (
              ...
              >
                ...
                <span className="font-bold text-[13px] text-[#1A1A1A]">{t('remedy.' + r.label)}</span>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <div className="flex justify-between items-center mb-10">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-yellow/10 flex items-center justify-center text-yellow-dark shrink-0">
              <TrendingUp size={19} />
            </div>
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.18em] text-[#D4A800]">Customer Favourites</p>
              <h2 className={`font-black text-[#1A1A1A] break-words ${lang === 'ta' ? 'text-xl sm:text-2xl leading-[1.4] tracking-[0] ta-text' : 'text-2xl sm:text-3xl tracking-tight'}`}>{t('top.title')}</h2>
            </div>
          </div>
          <Link to="/products"
            className="text-[13px] font-bold text-[#D4A800] hover:text-[#5e8c72] flex items-center gap-1 transition-colors">
      ...
      <section className="bg-white py-16 sm:py-24 border-y border-[#F0E6C8]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#D4A800]">Customer Reviews</p>
              <h2 className="text-3xl sm:text-[38px] font-black mt-3 mb-2 tracking-tight text-[#1A1A1A]">
                Trusted by Thousands
              </h2>
              <p className="text-[14px] text-[#6B7280] max-w-md font-medium leading-relaxed">
            ...
            <button
              ...
              className="shrink-0 inline-flex items-center gap-2 px-5 py-3 rounded-xl
                bg-[#1A1A1A] text-white font-bold text-[13px]
          ...
          <AnimatePresence>
            {reviewSubmitted && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0 }}
                className="mb-6 bg-yellow/10 border border-green-200 text-yellow-dark px-5 py-3.5 rounded-xl text-sm font-bold"
              >
          ...
          <AnimatePresence>
            {showForm && (
              <motion.form
                ...
                className="mb-10 bg-[#F7F6F2] rounded-2xl p-6 border border-[#F0E6C8]/40 overflow-hidden"
              >
                <h3 className="font-bold text-[#1A1A1A] mb-5 text-[15px]">Share Your Experience</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border-2 border-[#F0E6C8] focus:border-[#D4A800] outline-none bg-white text-[13px]"
                      value={reviewForm.name}
                      onChange={e => setReviewForm(f => ({ ...f, name: e.target.value }))}
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-[#6B7280] mb-1.5 uppercase tracking-wide">City / Location</label>
                    <input
                ...
                <div className="mb-4">
                  <label className="block text-xs font-bold text-[#6B7280] mb-2 uppercase tracking-wide">Rating *</label>
                ...
                <div className="mb-5">
                  <label className="block text-xs font-bold text-[#6B7280] mb-1.5 uppercase tracking-wide">Your Review *</label>
                  <textarea
                    required
                    rows={3}
                    placeholder="Tell others about your experience with our products..."
                    className="w-full px-4 py-2.5 rounded-xl border-2 border-[#F0E6C8] focus:border-[#D4A800] outline-none bg-white text-[13px] resize-none"
                ...
                <div className="flex gap-3">
                  <button type="submit" disabled={submitting}
                    className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-[#D4A800] hover:bg-[#5e8c72] text-white font-bold text-[13px] transition-colors disabled:opacity-60">
                    {submitting
                  ...
                  <button type="button" onClick={() => { setShowForm(false); setReviewError('') }}
                    className="px-5 py-2.5 rounded-xl border-2 border-[#F0E6C8] text-[#6B7280] font-bold text-[13px] hover:bg-[#F7F6F2] transition-colors">
                    Cancel
                  </button>
                </div>
              </motion.form>
          ...
          {reviewsLoading && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-5">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="bg-[#F7F6F2] rounded-2xl p-5 border border-[#F0E6C8]/30 animate-pulse">
                  <div className="h-3 bg-[#F0E6C8] rounded w-24 mb-4" />
                  <div className="h-2.5 bg-[#F0E6C8] rounded w-full mb-2" />
                  <div className="h-2.5 bg-[#F0E6C8] rounded w-4/5 mb-2" />
                  <div className="h-2.5 bg-[#F0E6C8] rounded w-3/5" />
                </div>
              ))}
            </div>
          )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {TESTIMONIALS.map((review, idx) => (
              <motion.div
                ...
                className="bg-[#F7F6F2] rounded-2xl p-5 sm:p-6 border border-[#F0E6C8]/30 flex flex-col gap-3.5 hover:shadow-md transition-shadow duration-300"
              >
                ...
                <p className="text-[13px] text-[#6B7280] leading-[1.65] flex-grow">&ldquo;{review.text}&rdquo;</p>
                <div className="flex items-center gap-2.5 pt-3 border-t border-[#F0E6C8]/40">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center text-white text-[10px] font-black shrink-0"
                    style={{ backgroundColor: review.color }}>
                    {review.initials}
                  </div>
                  <div>
                    <p className="font-bold text-[12px] text-[#1A1A1A] leading-tight">{review.name}</p>
                    <p className="text-[10px] text-[#6B7280] mt-0.5">{review.location}</p>
                  </div>
                </div>
              </motion.div>
            ))}
            ...
            {customerReviews.slice(0, 8).map((review) => {
              const colors = ['#D4A800', '#C4845C', '#8B7355', '#5e8c72']
              ...
              return (
                <motion.div
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  className="bg-[#F7F6F2] rounded-2xl p-5 sm:p-6 border border-[#D4A800]/20 flex flex-col gap-3.5 hover:shadow-md transition-shadow duration-300"
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[9px] font-bold text-[#D4A800] bg-[#D4A800]/10 px-2 py-0.5 rounded-full">Verified</span>
                  </div>
                  <p className="text-[13px] text-[#6B7280] leading-[1.65] flex-grow">&ldquo;{review.text}&rdquo;</p>
                  <div className="flex items-center gap-2.5 pt-3 border-t border-[#F0E6C8]/40">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center text-white text-[10px] font-black shrink-0"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        <div className="relative rounded-[2rem] overflow-hidden bg-[#1A1A1A] text-white
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2.5 px-9 py-4
                bg-white text-[#1A1A1A] font-black rounded-2xl
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-stretch">
          ...
          <a
            ...
            className="group relative rounded-[2rem] overflow-hidden
              border border-[#F0E6C8]/40 shadow-sm
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 z-10">
              <div className="w-16 h-16 rounded-full bg-[#1A1A1A] flex items-center justify-center shadow-xl
                group-hover:scale-110 transition-transform duration-300">
                <MapPin size={30} className="text-white" />
              </div>
              <div className="text-center">
                <p className="font-black text-[#1A1A1A] text-[15px]">{BRAND_EN}</p>
                <p className="text-[#6B7280] text-[12px] mt-1">Tamil Nadu, India</p>
              </div>
              <div className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl
                bg-[#1A1A1A] text-white text-[12px] font-bold
                group-hover:bg-[#D4A800] transition-colors duration-300">
          ...
          <div className="bg-white rounded-[2rem] p-8 sm:p-10
            ...
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#D4A800]">Find Us</p>
              <h2 className="text-2xl sm:text-3xl font-black mt-2.5 mb-4 text-[#1A1A1A] tracking-tight">
                Visit Our Store
              </h2>
              <p className="text-[#6B7280] text-[14px] leading-[1.7] font-medium mb-6">
              ...
              <div className="space-y-3.5">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#D4A800]/12 flex items-center justify-center shrink-0">
                    <MapPin size={16} className="text-[#D4A800]" />
                  </div>
                  <div>
                    <p className="font-bold text-[13px] text-[#1A1A1A] leading-tight">Store Location</p>
                    <p className="text-[13px] text-[#6B7280] mt-0.5">{BRAND_EN}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#D4A800]/12 flex items-center justify-center shrink-0">
                    <Phone size={16} className="text-[#D4A800]" />
                  </div>
                  <div>
                    <p className="font-bold text-[13px] text-[#1A1A1A] leading-tight">Call / WhatsApp</p>
                    <p className="text-[13px] text-[#6B7280] mt-0.5">{BRAND_WHATSAPP}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24 text-center">
        <h2 className={`font-black mb-8 text-[#1A1A1A] break-words ${lang === 'ta' ? 'text-xl sm:text-2xl leading-[1.4] tracking-[0] ta-text' : 'text-2xl sm:text-3xl tracking-tight'}`}>
          {t('more.title')}
        </h2>
        ...
        <Link
          ...
          className="inline-flex items-center gap-2.5 px-10 py-4 rounded-full
            bg-[#D4A800] text-white font-black
