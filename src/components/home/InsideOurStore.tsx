  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <p className="text-[10px] font-black uppercase tracking-[0.26em] text-[#D4A800] mb-3">
            A Glimpse of Our Tradition
          </p>
          <h2 className="text-[2rem] sm:text-[2.6rem] font-black text-[#1A1A1A] tracking-tight leading-[1.05] mb-4">
            Inside Our Store
          </h2>
          <p className="text-[15px] text-[#6B7280] font-medium leading-[1.7] max-w-lg mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center">
          ...
          <div className="w-full lg:w-[35%] shrink-0">
            ...
            <motion.p
              ...
              className="hidden lg:block text-[10px] font-black uppercase tracking-[0.26em] text-[#D4A800] mb-4"
            >
              A Glimpse of Our Tradition
            </motion.p>
            ...
            <motion.h2
              ...
              className="hidden lg:block text-[2.6rem] xl:text-[3rem] font-black text-[#1A1A1A] tracking-tight leading-[1.03] mb-5"
            >
              Inside Our Store
            </motion.h2>
            ...
            <motion.p
              ...
              className="hidden lg:block text-[15px] xl:text-[16px] text-[#6B7280] font-medium leading-[1.75] mb-8"
            >
            ...
            >
              {TRUST_BADGES.map((badge) => (
                <li key={badge} className="flex items-center gap-3">
                  <span className="flex-shrink-0 w-5 h-5 rounded-full bg-[#1A1A1A] flex items-center justify-center">
                    <Check size={11} strokeWidth={3} className="text-white" />
                  </span>
                  <span className="text-[14px] font-semibold text-[#1A1A1A]">{badge}</span>
                </li>
              ))}
            </motion.ul>
