  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center', borderBottom: '1px solid #e5e7eb', paddingBottom: 24, marginBottom: 24 }}>
        ...
        <div style={{ fontSize: 12, fontWeight: 800, color: '#1A1A1A', marginTop: 8, textTransform: 'uppercase', letterSpacing: 0.5 }}>
          INVOICE: {invoiceNo}
        </div>
          ...
          <div style={{ minWidth: 260 }}>
            ...
            <div
              style={{
                ...
                borderTop: '2px solid #D4A800', paddingTop: 12,
              }}
            >
              <span style={{ fontSize: 16, fontWeight: 900, color: '#D4A800', textTransform: 'uppercase', letterSpacing: 0.5 }}>Total</span>
              <span style={{ fontSize: 22, fontWeight: 900, color: '#D4A800' }}>{formatCurrency(total)}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div>
          <div style={{ fontSize: 13, fontWeight: 800, color: '#D4A800' }}>Thank you for shopping!</div>
